...
export const MENUS_POR_ROL: Record<Rol, MenuItem[]> = {
  ...
  COORDINACION_ACADEMICA: [
    ...
    { id: 'parametros',label: 'Parámetros del Programa', ruta: '/parametros-programa',    icono: '⚙️' },
    { id: 'reportes',  label: 'Reportes del Proceso',    ruta: '/reportes-proceso',       icono: '📊' },
  ],
  COORDINADOR_PRACTICAS: [
    ...
    { id: 'encuestas-coord',   label: 'Encuestas',             ruta: '/encuestas-coordinador',  icono: '📊' },
    { id: 'reportes',          label: 'Reportes del Proceso',  ruta: '/reportes-proceso',       icono: '📑' },
    { id: 'plantillas-correo', label: 'Plantillas de Correo',  ruta: '/plantillas-correo',      icono: '✉️' },
  ],
  DOCENTE_ASESOR: [
    { id: 'dashboard',     label: 'Panel Principal',  ruta: '/dashboard',       icono: '🏠' },
  ...
  TUTOR_EMPRESARIAL: [
    ...
    { id: 'planes',       label: 'Plan del Estudiante', ruta: '/planes',               icono: '📋' },
  ...
  ESTUDIANTE: [
    ...
    { id: 'seguimiento',label: 'Seguimiento Semanal', ruta: '/mi-practica/seguimiento',icono: '✏️' },
    { id: 'encuestas',  label: 'Mis Encuestas',       ruta: '/mis-encuestas',         icono: '📊' },
